...
const AdminSidebar= ()=>
{
    return (
      <div className="flex flex-col justify-between h-screen w-72 bg-blue-500 fixed">
        ...
        <div className="text-xl text-white font-semibold mt-8 flex flex-col items-center justify-start gap-18">
          {sidebarItems.map((items, index) => (
            <div className="hover:text-black hover:bg-white hover:p-2 p-2">{items.name}</div>
          ))}
        </div>
