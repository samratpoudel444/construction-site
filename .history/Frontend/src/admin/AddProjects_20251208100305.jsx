  ...
  return (
    <div className="">
      ...
      <div className="flex justify-center items-center mt-16">
        ...
        >
          <div className="sm:flex sm:flex-row flex flex-col gap-4 smitems-center text-lg">
          ...
          <div className="sm:flex sm:flex-row flex flex-col gap-4 justify-center items-center text-lg">
           <button className="p-2 rounded-2xl bg-blue-300 w-64 hover:bg-blue-400 text-white">Add Project</button>
          </div>
