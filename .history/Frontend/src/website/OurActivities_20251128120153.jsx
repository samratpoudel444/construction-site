...
const OurActivities = () => {
  return (
    <div className="flex flex-col sm:p-16">
      <div className="sm:p-4 p-4 mt-4 text-xl font-semibold text-blue-500 border-l-4 border-l-blue-500">
        <h1>Area of Activities</h1>
      </div>
      <div className="sm:flex sm:flex-row flex flex-col-reverse">
        <div className=" sm:flex sm:w-1/2 sm:h-96  sm:p-16 w-full h-48 mt-4">
          <Blank
      ...
      <div className="sm:flex sm:flex-row  flex flex-col">
        ...
        <div className=" flex sm:w-1/2 sm:h-96  sm:p-16 w-full h-48">
          <Blank
      ...
      <div className="sm:flex sm:flex-row  flex flex-col-reverse">
        <div className=" flex sm:w-1/2 w-full sm:h-96 h-48  sm:p-16">
          <Blank
            title="Concreting"
            content="IDCD is one of the most trusted builders with major experience 
            in concreting."
