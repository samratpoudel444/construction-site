...
const NavBar = () => {
  ...
  return (
    <div className="w-full flex justify-between items-center sm:px-8 sm:py-4 absolute">
      <div className="flex flex-row items-center sm:gap-4 justify-around">
      ...
      <div className="">
        {open && (
          <div className="absolute w-full h-screen bg-blue-500 left-0 top-0  sm:hidden flex flex-col gap-16 justify-center items-center text-2xl font-semibold">
            {navItems.map((item, index) => (
              <a
                key={index}
                href={item.link}
