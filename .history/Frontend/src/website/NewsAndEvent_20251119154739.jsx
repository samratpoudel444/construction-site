...
{
    return (
      <div className="sm:p-32 p-4 border-b-4 border-b-gra">
        ...
        <div className="sm:mt-16 mt-8 sm:grid sm:grid-cols-3 items-center sm:gap-16 flex flex-col gap-4 w-full">
          {news.map((data, index) => (
            <div className="p-4 border rounded-2xl flex flex-col items-center transision hover:scale-110 duration-500 bg-gray-300 ">
              <img src={data.Image} alt={data.Title} className="w-[90%] h-[75%]" />
