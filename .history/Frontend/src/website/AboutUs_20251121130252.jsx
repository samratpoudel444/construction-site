    ...
    return (
      <div className="flex flex-row sm:p-16 items-center justify-between gap-8">
        <div className="w-1/2">
          ...
          <div className="mt-4">
            <p className="For keeping <p> width consistent:
Method 1: Fixed Width
jsx<p className="w-64">Your text here</p>
Method 2: Max Width (prevents expanding)
jsx<p className="">
              ...
              Today, the company is actively engaged in a range of private
              infrastructure development works, including buildings, roads and
              highway and environmental management projects. With an expanding
              technical team and growing operational capacity, Indraakshi Divya
              Construction & Development Pvt. Ltd. continues to contribute to
              Nepal’s infrastructure sector while creating employment
              opportunities and delivering long-lasting value to clients and
              communities.
            </p>
          </div>
        </div>
