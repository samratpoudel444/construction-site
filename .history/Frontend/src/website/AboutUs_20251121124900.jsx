    ...
    return (
      <div className="flex flex-row sm:p-16 items-center justify-between gap-8">
        <div className="w-1/2">
          ...
          <div className="mt-4">
            <p className="text-leading">
              ...
              Since its establishment, the company has been focused on maintaining
            ...
            Today, the company is actively engaged in a range of private infrastructure development
              works, including buildings, roads and highways, water supply, and environmental management projects.
        ...
        <div className="sm:w-1/2">
          <img src={img2} alt="IDCD image" className="sm:border-2 sm:flex hidden" />
        </div>
      </div>
    );
}
