...
const OurActivities = () => {
  return (
    <div className="sm:px-32 sm:py-16 p-4 bg-gray-200">
      <div className="border-blue-500 border-l-4 p-4 flex justify-between items-center">
        <h1 className="text-2xl font-semibold text-blue-500">Our Activities</h1>
        <a href="#" className="text-blue-500">
          View All <Activities></Activities>
        </a>
      </div>
      <div className="m-4">
      ...
      <div>
        <div className="sm:flex sm:flex-row sm:gap-32 gap-8 sm:px-32 p-8 grid grid-cols-2 g">
