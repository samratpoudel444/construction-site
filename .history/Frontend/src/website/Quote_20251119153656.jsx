...
{
    return (
      <div className="bg-gray-300 sm:px-32  sm:flex sm:flex-row flex flex-col-reverse justify-between items-center font-extralight text-2xl w-f">
        <div className="p-4">
        ...
        <div className="m-8 rounded-full bg-blue-300">
