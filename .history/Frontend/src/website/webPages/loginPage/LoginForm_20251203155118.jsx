...
const LoginForm = () => {
  ...
  const [errors, setErrors] = useState({}); // store all field errors
  ...
  const handleSubmit = (e) => {
    ...
    if (!result.success) {
      // Convert Zod errors into simple object
      const fieldErrors = {};
      ...
      <div className="w-full max-w-md bg-gray-50 rounded-2xl shadow-xl p-8">
        ...
        >
          ...
          <div className="flex flex-col gap-2">
            ...
            <input
              type="text" // changed to text to disable browser's native email validation
