    ...
    return (
      <div className="sm:p-32 p-4 border-b-4 border-b-gray-300">
        ...
        <div className="sm:mt-16 mt-8 sm:grid sm:grid-cols-3 items-center sm:gap-16 flex flex-col gap-4 w-full">
          {news.map((data, index) => (
            <div className="p-4 rounded-2xl flex flex-col items-center justify-center transition-all hover:scale-110 duration-500 hover:bg-gray-300 bg-gray-200 w-full shadow-md">
              <img
                src={data.Image}
                alt={data.Title}
