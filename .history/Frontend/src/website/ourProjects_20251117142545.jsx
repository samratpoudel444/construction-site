...
const OurProjects = () => {
  return (
    <div className="sm:m-32 m-4 flex flex-col">
      ...
      <div className="sm:mt-16 mt-8 sm:grid sm:grid-cols-4 grid grid-cols-1 gap-4 sm:h-32 sm:w-full h-16">
        {data.map((value, index) => (
          <div
            key={index}
            className="w-full h-full relative hover:transition hover:scale-110 duration-300"
          >
            <img
              src={value.image}
              alt=""
